				...
				<div class="card-body">
					<div class="row no-gutters align-items-center">
						<div class="col mr-2">
							...
							<div class="text-md font-weight-bold text-dark text-
				...
				<div class="card-body">
					<div class="row no-gutters align-items-center">
						<div class="col mr-2">
							...
							<div class="text-md font-weight-bold text-dark text-
uppercase mb-1">Stok Buku Terdaftar</div>
				...
				<div class="card-body">
					<div class="row no-gutters align-items-center">
						<div class="col mr-2">
							...
							<div class="text-md font-weight-bold text-dark text-
uppercase mb-1">Buku yang dipinjam</div>
				...
				<div class="card-body">
					<div class="row no-gutters align-items-center">
						<div class="col mr-2">
							...
							<div class="text-md font-weight-bold text-dark text-
uppercase mb-1">Buku yang dibooking</div>
...
base_url('user/data_user'); ?>"><i class="fas fa-search mt-2 float-
right"> Tampilkan</i></a>
