...
<section>
		...
		<p align='justify'>Pada pengertian codeigniter di atas
			tadi di jelaskan bahwa codeigniter menggunakan metode MVC. Apa ituMVC? Kita juga harus mengetahui apa itu
			MVC sebelum masuk dan lebih
		...
		<ol type=”a”>
			...
			<p align='justify'>Dari penjelasan tentang model view dan controller
				...
				mendesign tampilann aplikasi, karena back-end developer
				yangmenangani bagian controller dan modelnya. Jadi pembagian tugas pun
