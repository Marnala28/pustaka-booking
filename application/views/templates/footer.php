	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-footer">
				<button class="btn btn-secondary" type="button submit" data-dismiss="modal">Cancel</button>
				<a class="btn btn-primary" href="<?=base_url('autentifikasi/logout'); ?>" type="submit" >Logout</a>
			</div>
		</div>
	</div>
</div>
